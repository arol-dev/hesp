        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <svg aria-hidden="true" className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">All Checkpoints
                </span>
              </div>
            </li>
          </ol>
        ...
        pd ? (
          PDs?.map((pd) => (
            <div>
              ...
              {pd.SessionNotes?.length ?
                <LastPDNotes lastPDCheckpoint={pd}></LastPDNotes> :
                <div className="lg:flex lg:items-center lg:justify-between pl-5 pr-5 pb-10">
                  <h3 className="text-xl font-bold leading-7 text-gray-500 sm:truncate sm:text-3xl sm:tracking-tight">
