...
import LastPD from "./LastPD";


function PDForm({ onRatingChange, PDSaved, lastPDCheckpoint }: PDFormProps) {
              ...
              <div className="px-4 sm:px-0">
                ...
                <div className="h-2 rounded-full bg-gray-300 w-1/2">
                  <div
                    ...
                    style={{ width: `${(rating.value / 5) * 100}%`, transition: 'width 0.5s ease-in-out' }}
                  ></div>
                </div>
              </div>
